...
urlpatterns = [
  ...
  path('admin/group/<int:pk>/students/search/', views.GroupStudentSearchAPIView.as_view(), name='group_students_search_api'),
  path('admin/group/<int:pk>/enrollment/add/', views.EnrollmentAddView.as_view(), name='enrollment_add'),
  path('enrollment/<int:pk>/remove/', views.EnrollmentRemoveView.as_view(), name='enrollment_remove'),
