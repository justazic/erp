...
class SubmissionCreateView(LoginRequiredMixin, View):
    def get(self, request, assignment_id):
        ...
        if assignment.is_expired():
            return render(request,'tasks/deadline_expired.html',{'assignment': assignment})
            
        return render(request, 'tasks/submission_create.html', {'assignment':assignment})
...
class SubmissionsListTeacherView(LoginRequiredMixin,View):
    def get(self,request, assignment_id):
        ...
        return render(request,'tasks/submission_list_teacher.html', {'assignment': assignment, 'submissions':submissions})
